...
1. 选择“+ 新建”，然后选择“表”，然后再次选择“表”。************

    ![“新建表”窗格的屏幕截图](../media/new-table-pane.png)

1. 输入 `Real Estate Property` 作为显示名称。**** 将自动填充复数名称。

1. 选择**主列**选项卡。

1. 输入 `Property Name` 作为显示名称。****
...
1. 输入 `Open House` 作为显示名称。**** 将自动填充复数名称。
